...
/* package HskNorem-0.1.0.0 */
#ifndef VERSION_HskNorem
#define VERSION_HskNorem "0.1.0.0"
#endif /* VERSION_HskNorem */
#ifndef MIN_VERSION_HskNorem
#define MIN_VERSION_HskNorem(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HskNorem */
...
#define CURRENT_COMPONENT_ID "HskNorem-0.1.0.0-inplace-HskNorem"
